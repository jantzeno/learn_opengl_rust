/*
    Transformations - With Excersice 1 at line 275
...
fn main() {
    ...
    while !window.source.should_close() {
        ...
        unsafe {
            ...
            // Exercise 1: try switching the order around by first rotating and then translating
            // move to the lower right hand corner
